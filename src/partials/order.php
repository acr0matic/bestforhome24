            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <div class="order__content">
                  ...
                  <p class="order__description">Сразу после подписания договора, наши специалисты приступают к выполнению заказа. В зависимости от сложности и загруженности производства, сроки изготовления могут варьироваться от 1 дня до 2-х недель.</p>
                </div>
                <!-- /.order-list__content -->
              </div>
              <!-- /.col-6 -->
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <div class="order__content">
                  ...
                  <p class="order__description">Мы даем гарантию 1 год на все наши услуги. Доставка и монтаж являются дополнительной услугой. Цена доставки и монтажа зависит от количества изделий, отдаленности и сложности объекта.</p>
                </div>
                <!-- /.order-list__content -->
              </div>
              <!-- /.col-6 -->

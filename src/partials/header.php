...
<body>
      ...
      <div class="page-loader__logo">
        <svg width="100%" height="100%" viewBox="0 0 164 164" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_369:62)">
            <path d="M102.995 31L68.3466 45.4367L39.6794 59.461L4 108.958H12.662L39.5834 71.5563L79.6898 120.095L104.232 50.5927L130.631 84.8284V71.4229L102.995 31Z" fill="#ECD031" />
            <path d="M172.361 76.1664L242 86.6846L130.631 84.8284V71.4229L172.361 76.1664Z" fill="#ECD031" />
            <path d="M99.695 78.8475H108.769V87.922H99.695V78.8475Z" fill="#ECD031" />
            <path d="M119.906 78.8475H110.832V87.922H119.906V78.8475Z" fill="#ECD031" />
            <path d="M28.7487 89.9844H37.8233V99.0589H28.7487V89.9844Z" fill="#ECD031" />
            <path d="M48.9601 89.9844H39.8856V99.0589H48.9601V89.9844Z" fill="#ECD031" />
            <path d="M39.6794 59.461V71.4229L12.662 108.958H4L39.6794 59.461Z" fill="#E1C83C" />
            <path d="M68.3464 45.4367L102.995 31L73.5024 76.1664L39.6792 59.461L68.3464 45.4367Z" fill="#D2BE4B" />
          </g>
          <defs>
  ...
  <div class="widget">
    ...
    <a class="widget__link widget__link--hide" href="https://t.me/" target="_blank">
      <img src="img/icons/widget/vk.svg" alt="" class="widget__icon widget__icon--small">
    </a>

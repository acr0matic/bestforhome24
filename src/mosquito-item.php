  ...
  <section id="compatibility" class="section">
    <div class="container">
      <div class="compatibility">
        <h2 class="section__title">С чем совместимо?</h2>
        ...
        <div class="swiper swiper--shadow swiper--mobile slider-compatibility">
          <div class="swiper-wrapper row">
            ...
            <div class="swiper-slide col-12 col-md-6">
              <div class="constuction__item">
                <div class="constuction__picture">
                  <img src="img/catalog/mosquito/constuction/standart.svg" alt="" class="constuction__image image">
                </div>
          ...
          <div class="swiper-wrapper row">
            ...
            <div class="swiper-slide col-12 col-md-4 mb-4">
              <div class="material__item">
                ...
                <div class="material__content">
                  <p class="material__description">
                    Устойчиво к повышенной влажности и солнечному излучению. Устойчиво к повышенной влажности и солнечному излучению.
                  </p>
                </div>
                <!-- /.material__content -->
